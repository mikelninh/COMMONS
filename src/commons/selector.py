...
from commons.models import CapabilityMatch, LiveCapabilitySelection
...
def build_live_choice_criteria(candidates: list[CapabilityMatch]) -> dict[str, str]:
...
class JevCapabilitySelector:
    ...
    def choose(
        ...
        *,
        ...
        criteria = build_live_choice_criteria(candidates)
        state = {
            "need": need,
            "context": context or {},
